            ...
            <div x-show="formStep === 3" class="space-y-4">
                ...
                <div class="grid gap-2 px-5 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1">
                    <div class="p-3">
                        ...
                        <input wire:model.defer="form.person.location" type="number"  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="ادخل العنوان " >
                    </div>
                    <div class="p-3">
                    ...
                    @if ($form['person']['location_type'] == 3)
                        <div class="p-3">
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">اقرب نقطة دالة</label>
                            <input wire:model.defer="form.person.rent" type="number"  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="ادخل اقرب " >
                        </div>
                    @endif
                </div>
                <x-ui.button></x-ui.button>
                            ...
                            <div :key="$index.now()" class="p-5 mt-3 border rounded-lg bg-gray-50-lg">
                                ...
                                <div class="grid gap-3 mt-3 lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-1">
                                    <div>
                                        ...
                                        <input wire:model.defer="form.family_members.{{ $index }}.name" type="number"  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="ادخل الاسم" >
                                    </div>
                                    <div>
                                        <label  class="block mb-2 text-sm font-medium text-gray-900 ">اختر نوع السكن</label>
