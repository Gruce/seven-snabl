        ...
        <div class="flex justify-between px-4 pt-4">
            ...
            <div>
                ...
                <div id="dropdown"
                    ...
                    style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate(614px, 2991px);">
                    <ul class="py-1" aria-labelledby="dropdownButton">
                        <li>
                            <a href="{{ route('show', ['id' => $form->id]) }}"
                                class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">استعراض</a>
                        </li>
                        <li>
                            <a wire:click="$emit('getFormId', '{{ $form->id }}')" @click="$openModal('cardModal')"
                                class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">
                                تقديم هبه</a>
                        </li>
                        <li>
                            <a wire:click="confirm({{ $form->id }},'delete')"
                                class="block py-2 px-4 text-sm text-red-600 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">حذف</a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <ul class="flex">
                    <li class="ml-1 grow">
                        <button x-show="activeTab === 'first'" @click="activeTab = 'first'"
                            class="w-full rounded text-gray-900 bg-gray-300 p-1" slate outline href="#first"
                    ...
                    <li class="ml-1 grow">
                        <button x-show="activeTab === 'second'" @click="activeTab = 'second'"
                            class="w-full rounded text-gray-900 bg-gray-300 p-1" slate outline href="#second"
                    ...
                    <li class="grow">
                        <button x-show="activeTab === 'third'" @click="activeTab = 'third'"
                            class="w-full rounded text-gray-900 bg-gray-300 p-1" slate outline href="#third"
                            icon="user-group">العائلة</button>
                        <button x-show="activeTab != 'third'" @click="activeTab = 'third'"
                            class="w-full rounded text-gray-900 bg-gray-100 p-1" href="#third"
                            icon="user-group">العائلة</button>
                    </li>
                </ul>
            </nav>
                ...
                @if ($family_count > 1)
                    <div class="flex justify-center my-1">
                        <button type="button" x-show="max > count" @click="count++" xs @click="count--"
                            class="px-3 py-2 text-xs font-medium text-center text-black bg-gray-200 rounded-lg  focus:outline-none focus:ring-blue-300">
