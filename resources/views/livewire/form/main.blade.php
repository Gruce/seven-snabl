    ...
    <div class="mt-3" x-cloak x-data="{ open: false, filter: false, addGiven: false }">
        <div class="grid gap-2 p-2 mb-3 rounded-lg lg:grid-cols-2 sm:grid-cols-1 bg-slate-50">
            ...
            <div class="flex justify-end ml-5">
                <input placeholder="ادخل اسم رب الاسرة او الزوجة" wire:model="filter.search" class=" bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-30 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" @keydown.enter.prevent="$refresh" />
                <button @click="filter = ! filter" class="w-16 mr-4  text-gray-200 bg-blue-700 rounded-lg "><i class="fa-solid fa-filter"></i></button>
            </div>
        </div>
        {{-- FILTERS --}}
        <div x-show="filter" class="grid lg:grid-cols-3 sm:grid-cols-1 mb-5 ">
            <select wire:model="filter.city_id" class="mr-2 text-sm text-gray-900 bg-white border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">
            ...
            <select wire:model="filter.person.level" class="mr-2 text-sm text-gray-900 bg-white border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">
            ...
            <select wire:model="filter.review" class="mr-2 text-sm text-gray-900 bg-white border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">
