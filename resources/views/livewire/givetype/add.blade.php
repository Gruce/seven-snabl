<div>
    <div class="grid grid-cols-1 gap-2">
        ...
        <input type="text" wire:model.defer="give.name" class=" bg-white border col-span-2 border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 p-2.5 ">
    </div>
