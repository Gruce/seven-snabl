                    ...
                    <x-ui.card class="border ">
                        <div class="flex justify-between">
                            ...
                            <div class="flex  text-xs">
                                    <button  wire:click="confirmed({{$city->id}})"   type="button" class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-1.5 mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">
