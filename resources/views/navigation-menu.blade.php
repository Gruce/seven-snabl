<nav x-cloak x-cloak x-data="{ open: false }" class="bg-white border-b border-gray-200">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        ...
                        <img src="{{ asset('img/a.png') }}" class="mt-3 pb-3" alt="logo" width="60" height="60">
                    </a>
                </div>

                <!-- Navigation Links -->
                <div class="hidden space-x-8 rtl:space-x-reverse  sm:-my-px sm:mr-10 sm:flex">
                ...
                <div class="ml-3 relative">
                    <x-jet-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <!-- Authentication -->
                            <form method="POST" action="{{ route('logout') }}" x-cloak x-data>
                                @csrf
